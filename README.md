...
- Q 1：如何修改預設輸出簡體中文
  - A 1：請戟開jyutsp_goi.schema.yaml，揾到“字形 → 大陸”呢行，喺上邊嘅“reset: 2"改成”reset: 0“，保存並重新部署。你都可以用“ctrl+Q”快速切換。
...
- Q 4:點解要加輔助碼，輔助碼點解係倉頡碼。
  ...
  - A 4.2:倉頡僅120個倉頡字母，學習成本相對較低，且多數港澳台學校都有教導。
